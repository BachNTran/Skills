...
Say: "You have [N] unscored ideas in `docs/ideas/`. Want to triage them?"
Suggest: `/triage`
...
Read `DEV_TRACKER.md` and resume the active wave.
...
- "What should I work on?" → show ROADMAP.md Now column
...
- Never start planning without reading current DEV_TRACKER.md first
